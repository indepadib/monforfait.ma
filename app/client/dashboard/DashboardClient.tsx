...
import { 
  ...
  ShieldCheck, Search, Sparkles, Send, User, MapPin, 
  Phone, ArrowLeft, ArrowRight, Calendar, Zap, Download, Upload, DollarSign, 
} from 'lucide-react';
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-3xl p-8 border border-zinc-200 dark:border-zinc-800 shadow-sm space-y-6">
              ...
              <div className="relative pl-6 sm:pl-0 sm:flex justify-between items-start gap-4">
                ...
                <div className="hidden sm:block absolute top-4 left-4 right-4 h-0.5 bg-zinc-100 dark:bg-zinc-800 -z-0" />
                <div
                ...
                <div className="sm:hidden absolute left-4 top-4 bottom-4 w-0.5 bg-zinc-100 dark:bg-zinc-800" />
                {[{ step: 1, label: 'Demande Reçue', desc: 'Vos besoins ont été enregistrés.' },
                  ...
                  { step: 4, label: 'Service Activé', desc: 'Votre Fibre est fonctionnelle.' }].map((s) => {
